...
void reseed_surface_particles_on_device(int n_cells, CUVEC::Vec3i *coords, CUVEC::Vec3d *sp, CUVEC::Vec3d *pp, CUVEC::Vec3d *np, scalar_t* LS, scalar_t *LS_grad_x, scalar_t *LS_grad_y, scalar_t *LS_grad_z, int sp_per_cell, int sign_per_cell, scalar_t bandwidth, SimParams *C, int threads_in_block);
